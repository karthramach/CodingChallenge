...
def Data_Loading():
    ...
    try:
        ...
        CREATE TABLE breweries (address_2 VARCHAR(100),address_3 VARCHAR(100),brewery_type VARCHAR(30),
                                city VARCHAR(40),country CHAR(13),county_province VARCHAR(40),id VARCHAR(100),latitude TEXT,
                                longitude TEXT,name VARCHAR(100),number_of_ratings NUMERIC,phone VARCHAR(30),postal_code VARCHAR(30),
...
def Data_Analysis_Final():                  
    ...
    try:
            ...
            print ("\nKindly enter the your current latitude and longitude positions to fetch the closest brewery to you\n")
